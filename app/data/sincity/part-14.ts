...
const PARAGRAPH_THEMES_58 = [
  {
    ...
    passage: 'İngiliz ve Fransız hükümetleri ses hızını aşan lüks yolcu uçağı "Concorde"u üretmek için devasa bir projeye giriştiler. Ancak proje ilerledikçe maliyetler korkunç boyutlara ulaştı ve uçağın hiçbir zaman ticari olarak kâr edemeyeceği, tamamen zarar edeceği matematiksel olarak kesinleşti. Mantıklı olan, projeyi anında iptal edip zararı durdurmaktı. Peki devletler ne yaptı? "Bugüne kadar o kadar milyarlarca dolar harcadık ki, şimdi vazgeçersek bu paralar çöpe gider!" diyerek, bile bile o zarar kuyusuna milyarlarca dolar daha dökmeye devam ettiler! Psikolojiye "Batık Bedel Safsatası" (Sunk Cost Fallacy) olarak giren bu olay, insanın rasyonel aklının iflasıdır. İnsanoğlu, geçmişte ödediği bedellere (harcadığı zamana, paraya veya yıpranmış bir ilişkiye) öylesine duygusal ve kibirli bir şekilde bağlanır ki; geleceğini kurtarmak için o gemiyi terk etmek yerine, sırf geçmişteki zararını kabullenemediği için batan gemiyle birlikte dibe sürüklenmeyi (kendi yıkımını finanse etmeyi) seçer.',
    questionStem: 'Concorde uçağı projesi üzerinden anlatılan "Batık Bedel Safsatası", insan aklının karar alma mekanizmasındaki hangi irrasyonel (ve yıkıcı) zaafı eleştirir?',
    options: [
      'Devletlerin havacılık teknolojilerinde her zaman özel şirketlerden daha başarısız ve vizyonsuz olduklarını',
      'İnsanın (ve kurumların); geçmişte harcadığı emek, zaman veya parayı (zararı) kabullenememe kibri yüzünden; geleceğini kurtarmak yerine sırf o "batık yatırımı" haklı çıkarmak uğruna bile bile kendi yıkımına yatırım yapmaya devam ettiği akıl tutulmasını',
      'Uçak biletlerinin çok pahalı olmasının yolcu sayısını her zaman matematiksel olarak sıfıra indirdiğini',
      'Sesten hızlı yolculuğun insan anatomisine verdiği zararların mühendisler tarafından kasten gizlenmesini'
    ],
    correct: 1,
    explanation: 'Zarar edileceği bilindiği halde sırf "geçmişte çok para harcandı" diye projeye devam edilmesi; insanın geçmiş zararı kabullenememe kibri yüzünden bile bile kendi çöküşünü finanse ettiği o akıl tutulmasını (Batık Bedel Safsatasını) eleştirir.'
  },
  {
    title: 'Thomas Midgley Jr. (Dünyayı İki Kez Zehirleyen Dâhi)',
    passage: 'Tarihte hiçbir insan, gezegenin ekosistemine ve insan sağlığına Thomas Midgley Jr. adındaki tek bir Amerikalı kimyager kadar devasa ve acımasız bir zarar vermemiştir. Midgley, arabaların motorundaki vuruntuyu çözmek için 1920\'lerde "Kurşunlu Benzini" icat etti! Bu buluş sanayiyi hızlandırdı ama havaya saçılan kurşun, tüm dünyada milyonlarca çocuğun beynini zehirledi ve IQ seviyelerini kalıcı olarak düşürdü. İşin kâbusu burada bitmedi. Midgley daha sonra buzdolaplarını soğutmak için çok daha "güvenli" sandığı yeni bir gaz icat etti: "CFC (Kloroflorokarbon)!" Bu mucizevi (!) gaz da atmosferin en üstüne çıkarak Dünya\'yı güneşin radyasyonundan koruyan "Ozon Tabakası"nı kelimenin tam anlamıyla yırttı ve parçaladı! Midgley kötü niyetli bir terörist değildi; sorun çözmeye çalışan ödüllü bir mühendisti. Onun trajedisi, bilimsel kibrin o en karanlık ironisidir: İnsanoğlunun teknolojik sorunlara bulduğu o "kestirme ve dâhiyane" sanılan çözümler; doğanın görünmez dengesi hesaplanmadığında, koca bir gezegeni (havayı ve atmosferi) aynı elden iki kez zehirleyip yok edecek kadar kör ve apokaliptik birer silaha dönüşebilir.',
    questionStem: 'Thomas Midgley Jr.\'ın (Kurşunlu benzin ve CFC gazını icat etmesi) yarattığı küresel felaketler, "Bilimsel Çözümler ve Doğa" bağlamında neyin trajikomik (ve ölümcül) bir kanıtıdır?',
    options: [
      'Kimya biliminin sadece Amerikan üniversitelerinde üretilebilen yerel bir akademi alanı olduğunun',
      'Bilim insanlarının her zaman kasten ve şeytani planlarla insanlığı yok etmeye çalıştığı komplo teorisinin',
      'Kısa vadeli sorunları çözmek için üretilen (ve dâhiyane sanılan) teknolojik kestirme yolların; doğanın devasa ve karmaşık dengesi (nedenselliği) hesaba katılmadığında, dünyayı katleden öngörülemez ve ölümcül birer silaha (kıyamete) dönüşebileceği ironisinin',
      'Buzdolaplarının motorlarında kullanılan metallerin zamanla kurşuna dönüştüğü yönündeki fiziksel yanılgının'
    ],
    correct: 2,
    explanation: 'Sorun çözmek için bulunan kurşunlu benzin ve CFC gazının dünyayı iki kez felakete sürüklemesi; kısa vadeli (kibirli/kestirme) teknolojik çözümlerin, doğanın bütünü hesaplanmadığında gezegeni vuran apokaliptik silahlara dönüşebileceğini kanıtlar.'
  },
  {
    title: 'Büyük Oksidasyon Olayı (İlk ve En Sessiz Kıyamet)',
    passage: 'Bugün ciğerlerimize derin bir nefes çekerken oksijene (yaşama) şükrederiz. Oysa Dünya tarihindeki en büyük, en kan dondurucu toplu yok oluş göktaşlarıyla değil, bizzat o çok sevdiğimiz "Oksijen" ile yaşanmıştır! Günümüzden 2.4 milyar yıl önce okyanuslarda yaşayan ilkel Siyanobakteriler, güneş ışığını enerjiye çeviren o mucizevi formülü (Fotosentezi) icat ettiler. Ancak bu sürecin bir "yan ürünü (atığı)" vardı: Oksijen gazı! O dönemki dünya, oksijensiz ortamda yaşayan (anaerobik) canlılarla doluydu ve oksijen onlar için asitten farksız, ölümcül, yakıcı ve paslandırıcı bir zehirdi! Siyanobakteriler çoğalıp milyarlarca ton oksijeni atmosfere kustuğunda, yeryüzündeki yaşamın %99\'u bu zehirli gaza dayanamayarak (kavrularak) sonsuza dek yok oldu! Biyolojide "Büyük Oksidasyon Olayı" denen bu karanlık milat, evrenin o acımasız kuralını yüzümüze çarpar: Doğada "mutlak iyi veya kötü" yoktur. Bizim nefesimiz ve yaşama sebebimiz olan şey, milyarlarca yıl önce kendinden önceki tüm dünyayı küle çeviren o ilk ve en sessiz "kıyametin (zehrin)" ta kendisidir.',
    questionStem: '"Büyük Oksidasyon Olayı"nda oksijenin o dönemki canlıların %99\'unu yok etmesi, "Doğa ve Yaşam" algımızdaki hangi klasik/romantik ezberi darmadağın eder?',
    options: [
      'Oksijenin aslında sanayi devriminden sonra insan eliyle üretilen yapay bir gaz olduğu ezberini',
      'Bizim "mutlak yaşam kaynağı (iyilik)" olarak taptığımız oksijenin; aslında kendinden önceki koca bir ekosistemi asit gibi yakan (yok eden) bir zehir olduğunu, yani doğada mutlak iyi/kötü kavramının bulunmadığı ve hayatımızın geçmişteki devasa bir kıyametin (katliamın) üzerine kurulduğu gerçeğini',
      'Siyanobakterilerin dünyayı uzaylılardan korumak için özel olarak programlanmış savaşçılar olduğu efsanesini',
      'Atmosferdeki gazların yoğunluğunun sadece volkanik dağların aktivitesine bağlı olduğu dogmasını'
    ],
    correct: 1,
    explanation: 'Yaşam kaynağımız oksijenin eskiden canlıları katleden zehir olması; doğada "mutlak iyi" (romantik algı) olmadığını ve kendi nefesimizin aslında geçmişteki o devasa bir katliamın/kıyametin yan ürünü olduğunu ispatlar.'
  },
  {
    title: 'Rupert Damlası (Kırılmaz Camın Hassas Kuyruğu)',
    passage: 'Erimiş sıcak bir camı, soğuk suyun içine aniden damlatırsanız gözyaşı şeklinde bir "Prens Rupert Damlası" elde edersiniz. Bu cam damlasının "baş (yuvarlak)" kısmı fizikteki akıl sınırlarını donduran bir anormalliğe sahiptir: O baş kısmına çekiçle defalarca vurun, mengenede sıkıştırın veya üzerinden koca bir arabayla geçin; cam asla KIRILMAZ! Çeliği büken kuvvetler bu camın önünde çaresiz kalır. Ancak o yenilmez cam damlasının arkasında, iplik kadar incecik ve narin bir "kuyruk" uzanır. Eğer o incecik kuyruğun sadece ucundan "milimetrik" bir parçayı parmağınızla çitletir (kırarsanız), o çekiçlere dayanan devasa ve yenilmez baş kısmı; saniyenin onda biri hızında patlayarak mikroskobik tuz buz (toz) bulutuna dönüşür! İçerideki devasa yüzey gerilimi anında serbest kalarak tüm sistemi içeriden imha etmiştir. Rupert Damlası, gücün ve kibrin o en ironik felsefesidir: Dışarıdan gelen en ağır balyozlara (saldırılara) karşı yenilmez olan sistemler, devletler veya insan egoları; aslında kendi arkalarında sakladıkları o en ince, en zayıf ve görünmez kuyruklarından (içsel bir kırılmadan) tetiklendiğinde saniyeler içinde kendi içlerine çöküp tuz buz olmaya mahkûm, devasa ve gergin birer cam illüzyonudur.',
    questionStem: 'Prens Rupert Damlası\'nın (başına balyozla vurulsa kırılmayan ama kuyruğu kopunca patlayan cam) özellikleri, "Güç ve Sistemler" bağlamında neyin metaforik anıtıdır?',
    options: [
      'Cam ustalığının tarih boyunca sadece soylular (prensler) tarafından yapılabilen elit bir sanat olduğunun',
      'Dış saldırılara (balyozlara) karşı kusursuz ve "yenilmez" görünen devasa sistemlerin (veya egoların); aslında içlerindeki o yüksek (gergin) basınç yüzünden, en zayıf (kuyruk/içsel) noktalarından alınan ufacık bir hasarla saniyeler içinde kendi içlerine çöküp toz olabilecekleri ironisinin',
      'Soğuk suyun içine düşen her maddenin zamanla kimyasal olarak paslanıp kırılganlaştığı gerçeğinin',
      'İnsanoğlunun silahlara olan merakının zamanla cam üretimini tamamen durdurduğunun'
    ],
    correct: 1,
    explanation: 'Çekice dayanan camın kuyruğundan kırılınca patlaması; dışarıdan yenilmez görünen (gergin) sistemlerin/insanların, en zayıf içsel (kuyruk) noktasından vurulduklarında nasıl kendi kendilerine çöküp toz olduklarının (güç illüzyonunun) metaforudur.'
  },
  {
    title: 'Gödel\'in Eksiklik Teoremi (Aklın Çaresizliği)',
    passage: '1931 yılında yirmili yaşlarındaki matematikçi Kurt Gödel, binlerce yıldır kurulan o "Matematik her şeyi ispatlayabilir, insan aklı kusursuzdur" kibrine, kelimenin tam anlamıyla nükleer bir mantık bombası attı. "Eksiklik Teoremleri" ile şunu matematiksel olarak kanıtladı: "Yeterince karmaşık olan hiçbir mantık (veya matematik) sistemi, kendi içindeki bütün doğruları ASLA kanıtlayamaz!" Yani bir sistemin içinde yaşıyorsanız, o sistemin kusursuz ve çelişkisiz olduğunu "o sistemin kendi kurallarıyla" ispatlamanız evrensel (ve mantıksal) olarak imkânsızdır! Her sistemde, doğru olduğu bilinen ama asla ve asla formüllerle ispatlanamayan (havada asılı kalan) karanlık boşluklar vardır. Gödel\'in bu ispatı; aklın, mantığın ve bilimin o "her şeyi çözecek Tanrısal anahtar" olma fantezisini yırtıp atar. İnsan beyni ne kadar gelişirse gelişsin; kâinatın ve mantığın o devasa mimarisi içinde daima kör kalacağı, asla kanıtlayamayacağı ve önünde çaresizce diz çökeceği o sessiz (ve eksik) duvarlara çarpmaya mahkûmdur.',
    questionStem: 'Kurt Gödel\'in Eksiklik Teoremi (hiçbir sistemin kendi içindeki tüm doğruları ispatlayamayacağı kuralı), felsefi olarak "İnsan Aklı ve Bilim" hakkında hangi radikal sınırı (gerçeği) çizer?',
    options: [
      'Matematik formüllerinin sadece kâğıt üzerinde doğru çalışıp gerçek hayatta her zaman yanlış sonuçlar vereceğini',
      'Akıl, mantık ve bilimin evrendeki "her şeyi (kusursuzca) ispatlayıp çözebileceği" yönündeki o tanrısal kibri yıkarak; düşünce sistemlerimizin kendi doğası gereği daima eksik, kanıtlanamaz kör noktalara ve aşılamaz mantıksal duvarlara (çaresizliğe) sahip olduğu sınırını',
      'Hesap makinelerinin ve bilgisayarların ileride insan beyninden çok daha geride kalarak iflas edeceğini',
      'Kuantum dünyasında rakamların ve toplama işlemlerinin hiçbir fiziksel anlam ifade etmediğini'
    ],
    correct: 1,
    explanation: 'Gödel\'in matematiğin her şeyi kanıtlayamayacağını ispatlaması; aklın ve bilimin "her şeyi çözecek (kusursuz) anahtar" olduğu kibrini yıkarak, mantığın doğası gereği daima eksik, kanıtlanamaz ve aşılamaz duvarlara/kör noktalara sahip olduğunu çizer.'
  },
  {
    title: 'Uzay Kalemi Safsatası (Popülist Cehalet)',
    passage: 'Herkes o meşhur ve tatlı fıkrayı bilir: "NASA, uzayda yerçekimi olmadığı için yazmayan tükenmez kalemleri çalışsın diye milyonlarca dolar harcayıp Uzay Kalemi\'ni (Space Pen) icat etti. Ruslar ise sadece kurşun kalem kullandı!" İnsanlar bu hikâyeyi duyduğunda "İşte Amerikan kibri ve Rusların kıvrak (halk) zekâsı!" diyerek bilime gülerler. Oysa gerçek, bu popülist ve tehlikeli yalanın suratına acımasızca tükürür: Uzayda yerçekimi olmayan bir mekikte "kurşun kalem" kullanmak, yapılabilecek en ahmakça ve ölümcül intihardır! Kurşun kalemin ucundan kopan mikroskobik (ve iletken) grafit tozları, o sıfır yerçekimi ortamında havada süzülerek doğrudan astronotların ciğerlerine girer veya elektrik panellerine sızarak o koca uzay gemisini saniyeler içinde kısa devreyle patlatıp yok eder (NASA da Ruslar da bunu bildiği için o özel basınçlı kalemi ortak kullanmışlardır). Uzay Kalemi efsanesi; kitlelerin karmaşık bilimi ve uzmanlığı aşağılamak için uydurduğu o sığ "halk zekâsı (pratik çözüm)" güzellemesinin; aslında gerçek hayatta (fiziğin acımasız kuralları karşısında) koskoca bir uzay gemisini yakıp kül edecek kadar cahilce ve ölümcül bir cehalet güzellemesinden başka bir şey olmadığının kanıtıdır.',
    questionStem: '"NASA milyonlar harcadı, Ruslar kurşun kalem kullandı" yalanının (aslında kurşun kalemin uzayda ölümcül grafit tozu saçması), toplum ve "Bilim Algısı" bağlamında neyin tehlikeli bir eleştirisidir?',
    options: [
      'Rus kozmonotların Amerikan astronotlarına göre her zaman daha cesur ve yetenekli olduğunun',
      'Mürekkebin uzayda oksijensiz ortamda anında donarak kalemi tamamen işlevsiz hale getirdiğinin',
      'Toplumun, bilimi ve uzmanlığı (karmaşık çözümleri) aşağılamak uğruna uydurduğu (ve yücelttiği) o sığ "pratik/halk zekâsı" fıkralarının; fiziğin ve gerçeğin o ölümcül kuralları karşısında aslında ne kadar cahil, yıkıcı ve uydurma bir popülizm (kibir) olduğunun',
      'Uzay mekiklerinin içinde not tutmanın aslında tamamen yasak ve gereksiz bir eylem olduğunun'
    ],
    correct: 2,
    explanation: 'Kurşun kalem yalanının popüler olup gerçeğin (grafik tozunun gemiyi patlatacağı) bilinmemesi; toplumun bilimi/uzmanlığı aşağılamak için uydurduğu o sığ (popülist) "pratik halk zekâsı" masallarının aslında ne kadar tehlikeli ve cahilce olduğunu eleştirir.'
  },
  {
    title: 'MacGuffin (Anlamsızlığın Peşindeki Sürü)',
    passage: 'Efsanevi yönetmen Alfred Hitchcock sinema tarihini derinden sarsan o karanlık terimi icat etti: "MacGuffin". Bir casusluk veya aksiyon filminde herkes siyah bir çantanın, gizli bir mikroçipin veya bir kolyenin peşinde koşar. Uğruna insanlar birbirini öldürür, arabalar patlar, savaşlar çıkar. Ancak filmin sonunda o çantanın içinde ne olduğunun HİÇBİRDEN önemi yoktur! MacGuffin, kendi başına tamamen anlamsız, boş ve değersiz olan; ancak sırf "karakterleri harekete geçirmek, çatışma yaratmak ve hikâyeyi (filmi) ilerletmek" için kasten uydurulmuş (ve değer atfedilmiş) bir araçtır. Bu sinema hilesi, insanlık durumunun (ve hayatın) en dondurucu özetidir: Sabah sekizde kalkıp uğruna ömrümüzü tükettiğimiz statü, o lüks arabalar, bankadaki rakamlar veya siyasi davalar... Bizler, aslında kendi içinde hiçbir evrensel (ve mutlak) anlamı olmayan, sadece bu devasa "Hayat Tiyatrosu"nda bizi hareket ettirsin (oyalamaya devam etsin) diye sistemin ortaya attığı o "Boş Çantaların (MacGuffin\'lerin)" peşinde koşarak kendi kendini tüketen trajik (ve terleyen) figüranlarız.',
    questionStem: 'Alfred Hitchcock\'un "MacGuffin" (içi boş ama herkesin uğruna savaştığı nesne) kavramı, yazar tarafından "insan hayatı ve koşturmacası" hakkında neyin felsefi metaforu yapılmıştır?',
    options: [
      'Sinema filmlerinin aslında gerçeği yansıtmayan ve insanları şiddete yönlendiren zararlı yapımlar olduğunun',
      'İnsanoğlunun hayat boyu uğruna savaştığı, kan döktüğü (statü, para, hırs) nesnelerin; kendi başlarına mutlak hiçbir değeri/anlamı olmayan, sadece bizi bu hayatta oyalayıp koşturmaya (sistemi ilerletmeye) yarayan "içi boş kurgusal araçlar (illüzyonlar)" olduğunun',
      'Aksiyon filmlerinde kullanılan siyah çantaların her zaman çok gizli devlet sırları barındırdığının',
      'Oyuncuların filmlerde kendi kişisel hayatlarını oynadıkları için senaryoya ihtiyaç duymadıklarının'
    ],
    correct: 1,
    explanation: 'Filmdeki içi boş ama herkesi koşturan çanta (MacGuffin); insanın hayatta peşinden koştuğu statü, hırs ve paranın aslında mutlak hiçbir değeri olmayan, sadece bizi oyalayıp yaşatmaya (hareket ettirmeye) yarayan kurgusal illüzyonlar olduğunun metaforudur.'
  },
  {
    title: 'James Vicary (Bilinçaltı İllüzyonu)',
    passage: '1957 yılında James Vicary adında bir piyasa araştırmacısı dünyayı dehşete düşürdü. Bir sinema salonunda film oynatılırken, insan gözünün yakalayamayacağı kadar yüksek bir hızda (saniyenin 3.000\'de biri) ekrana "Patlamış Mısır Ye" ve "Coca-Cola İç" yazılı mesajlar fırlattığını iddia etti! Vicary\'e göre izleyiciler bu mesajı bilinçleriyle görmemiş ama bilinçaltları o mesajı (hipnoz gibi) gizlice emdiği için mısır ve kola satışları anında %50 fırlamıştı! Bu açıklama üzerine tüm dünya medyası ayağa kalktı, devletler "Bilinçaltı Reklamcılığını (Subliminal Messages)" insan aklını çalan şeytani bir silah olarak yasakladı. Yıllar sonra işin asıl akıl yakan, karanlık gerçeği ortaya çıktı: Vicary o deneyi HİÇBİR ZAMAN YAPMAMIŞTI! Ortada ne mesaj vardı ne de artan bir satış; o batan şirketine müşteri çekmek için bu yalanı uydurmuştu. Ancak James Vicary Skandalı, kitle psikolojisinin o zavallı (ve paranoyak) fethidir: İnsanoğlu, "Kendi hür iradesiyle karar aldığına" inanmaktansa; "Gizli, karanlık ve üstün güçler benim bilinçaltımı hackliyor, ben o yüzden böyle davranıyorum" yalanına inanmaya çok daha aç, çok daha dünden razı bir komplo bağımlısıdır.',
    questionStem: 'James Vicary\'nin "Bilinçaltı (Subliminal) Reklamcılık" iddialarının tamamen yalan olmasına rağmen tüm dünyanın buna inanıp yasaklar koyması, insan psikolojisindeki hangi paranoyak "zaafı" ifşa eder?',
    options: [
      'Sinema filmlerinin uzun süre izlendiğinde insanlarda şeker ve asitli içecek tüketimini biyolojik olarak artırdığı gerçeğini',
      'Hükümetlerin reklam ajanslarını kasten kapatarak ekonomiyi devlet tekeline almak istemelerini',
      'İnsanoğlunun; kendi davranışlarının ve zaaflarının sorumluluğunu almak yerine, "Gizli, karanlık ve üstün bir gücün benim zihnimi/bilinçaltımı dışarıdan ele geçiriyor (hackliyor)" şeklindeki o komplo teorilerine (ve mağduriyet kurgusuna) inanmaya olan hastalıklı açlığını (zaafını)',
      'Gözlerimizin saniyenin binde biri hızındaki görüntüleri asla algılayamayacak kadar yavaş bir evrim geçirdiğini'
    ],
    correct: 2,
    explanation: 'Adamın yalan söylemesine rağmen tüm dünyanın "bilinçaltımız kontrol ediliyor" yalanına inanması; insanın kendi seçimlerinin sorumluluğunu almak yerine "üstün/gizli bir güç beynimi hackledi (ben mağdurum/kuklayım)" komplo teorisine inanmaya olan o hastalıklı açlığını (zaafını) ifşa eder.'
  },
  {
    title: 'Mars Climate Orbiter (Matematiğin Körlüğü)',
    passage: '1999 yılında NASA, Mars gezegeninin atmosferini ve iklimini incelemek için 125 milyon dolarlık muazzam teknolojik bir uyduyu (Mars Climate Orbiter) fırlattı. Uydu, milyonlarca kilometre yolu kusursuzca katetti ve Mars\'ın yörüngesine yaklaştı. Ancak manevra yapmak için motorlarını ateşlediği an, uzay aracı hesaplanan rotasından feci şekilde saptı, gezegenin atmosferine ölüm dalışı yaparak saniyeler içinde yanıp kül oldu! Sonrasında kurulan kaza araştırma komisyonu, bu devasa fiyaskonun sebebini bulduğunda bilim dünyası utançtan yerin dibine girdi. Uzay aracını yapan "Lockheed Martin" mühendisleri, itme kuvveti yazılımlarında Amerikan ölçü sistemi olan "Pound-Force (İngiliz/İnç birimi)" kullanmıştı! Ancak NASA\'daki (ve dünyadaki) navigasyon ekibi ise bu verileri metrik sistem olan "Newton" olarak (öyle varsayarak) bilgisayarlara işlemişti! Ortada mekanik bir arıza veya uzaylı saldırısı yoktu; o 125 milyon dolarlık şaheser, sadece iki koca laboratuvarın "birbirinin hangi birimi kullandığını" sormayı unuttuğu o akılalmaz derecede sığ, cahilce ve kibirli bir (basit) iletişim kopukluğu yüzünden Mars\'ın kızıl gökyüzünde bir ateş topuna dönüştü.',
    questionStem: '125 milyon dolarlık Mars Climate Orbiter uydusunun "metrik ve inç birimlerinin birbirine karıştırılması" yüzünden yok olması, karmaşık sistemler (ve bilim) hakkında neyin (ironik) ispatıdır?',
    options: [
      'Mars atmosferinin tahmin edilenden çok daha kalın ve asidik bir yapıya sahip olduğunun ispatı',
      'İnsanlığın o devasa teknolojik kibrinin (ve karmaşık sistemlerinin); okyanusları aşsa bile, o en basit, en "temel (aptalca) bir iletişim/koordinasyon hatası (birim uyuşmazlığı)" karşısında saniyeler içinde çöpe dönüşüp kül olabileceği (ve iflas edebileceği) ironisi',
      'Amerikan ve Avrupa uzay ajanslarının her zaman birbirlerinin projelerini gizlice sabote ettiğinin kanıtı',
      'Uzay gemisi yazılımlarında sadece matematiksel rakamların değil harflerin de kullanılması gerektiği yönündeki kural'
    ],
    correct: 1,
    explanation: 'Devasa bir uydunun sadece iki ekibin "pound mu newton mu" kullandığını birbirine sormaması (basit birim hatası) yüzünden kül olması; devasa teknolojik sistemlerin/kibrin en aptalca (ve basit) iletişim hataları karşısında nasıl çöpe döndüğünün ironik ispatıdır.'
  },
  {
    title: 'Folie à Deux (Paylaşılan Cinnet)',
    passage: 'Psikolojide, akıl hastalığının ve deliliğin sadece "tek bir beyne" ait bir hastalık (bozukluk) olduğu sanılır. Ancak 2008 yılında İngiltere otoyolunda İsveçli tek yumurta ikizleri Ursula ve Sabina Eriksson\'un yaşadıkları olay, beyni felç eden o karanlık zihinsel salgını (Folie à Deux / Paylaşılmış Psikotik Bozukluk) tüm çıplaklığıyla kameraya kaydetti. İkizlerden sadece biri (Sabina) ağır bir paranoya krizine girmiş ve peşinde katillerin olduğuna inanmıştı. Ancak asıl kâbus; tamamen "sağlıklı" olan diğer kız kardeşin (Ursula\'nın), kardeşiyle o izole (kapalı) sevgi bağı yüzünden onun o "sahte deliliğine (halüsinasyonlarına)" kelimenin tam anlamıyla enfekte olup (bulaşıp) SIFIR ŞÜPHEYLE inanmasıydı! İki kadın birden çığlıklar atarak kendilerini otoyolda (polisin gözü önünde) vızır vızır geçen tırların altına attılar! Folie à Deux bize o korkunç kuralı öğretir: Delilik (veya fanatizm), kapalı ve izole bir bağ (tarikat veya aile) içinde yaşandığında sadece bireysel bir hasar olarak kalmaz. Sağlıklı (rasyonel) bir beyin bile, izole edildiği bir sistemin içinde duyduğu o sürekli ve şiddetli sanrılara (yalanlara) maruz kaldığında; o yalanı kucaklayarak kendi gerçekliğini silecek kadar bulaşıcı bir "kolektif cinnetin (ortak kâbusun)" içine hapsolmaya mahkûmdur.',
    questionStem: 'Folie à Deux (İkizlerin aynı halüsinasyona kapılıp tırların altına atlaması) sendromu, "İnsan Aklı ve Gerçeklik (Delilik)" algısı hakkında hangi dondurucu tehlikeyi ifşa eder?',
    options: [
      'İkiz kardeşlerin genetik olarak sadece aynı hastalıklara aynı anda yakalanabilen biyolojik kopyalar olduğu kuralını',
      'İngiltere otoyollarındaki trafik gürültüsünün insanlarda geçici duyma ve görme kayıpları yarattığını',
      'Deliliğin (sanrıların ve kurguların) sadece tek bir bireye özgü fiziksel bir hasar olmadığını; kapalı, izole ve duygusal bir bağ (ortam) içinde, tamamen sağlıklı bir aklın bile o yalana/sanrıya (virüs gibi) "enfekte olarak" ortak bir kolektif cinnete (karanlığa) sürüklenebileceği tehlikesini',
      'Avrupa ülkelerinde ruh sağlığı hastanelerinin yeterli kapasiteye sahip olmadığı için hastaların sokaklara bırakıldığını'
    ],
    correct: 2,
    explanation: 'Sağlıklı kardeşin de ötekinin deliliğine inanıp kamyonun altına atlaması; deliliğin/sanrıların izole sistemlerde (virüs gibi) bulaşıcı olduğunu ve sağlıklı bir aklın bile o yalanla enfekte olup kolektif bir cinnete sürüklenebileceğini (Folie à Deux) ifşa eder.'
  },
  {
    title: 'Gümüş Tilki Deneyi (Uysallığın Bedeli)',
    passage: '1959 yılında Sovyet genetikçi Dmitry Belyaev, Sibirya\'da akıllara zarar bir deney başlattı: "Bir kurdu köpeğe çeviren o evrimsel süreci (evcilleştirmeyi) laboratuvarda yeniden canlandırabilir miyim?" Bunun için yüzlerce vahşi, agresif ve insanı ısıran "Gümüş Tilki"yi kafeslere koydu. Sadece ve sadece insana karşı en "sakin, en saldırgan olmayan (uysal)" yavruları seçip onları kendi aralarında çiftleştirdi. Bu uysallık seçimi sadece birkaç nesil (birkaç yıl) sürdü. Tilkiler köpek gibi kuyruk sallamaya, insanın elini yalamaya başladı. Ancak Belyaev\'i asıl şoka sokan şey bu uysallık değildi! Sadece uysallık genini seçmesine rağmen, tilkilerin o dik kulakları tıpkı köpeklerinki gibi kıkırdaksızlaşıp (sarkık) düştü! Tüylerinde ineklerinki gibi siyah-beyaz benekler çıktı, çeneleri (ve dişleri) küçüldü! Biyolojiye "Evcilleştirme Sendromu" (Domestication Syndrome) olarak giren bu kural, evrimin o affetmeyen ironisidir: Doğada bir canlının o agresif, vahşi ve özgür ruhunu (adrenalini) koparıp onu uysal ve itaatkâr (köle) bir canlıya dönüştürdüğünüz an; bedeni de o saflığı, estetiği ve yırtıcılığını kaybeder. Ruhun itaatkârlaşması (uysallık), bedenin fiziksel deformasyona ve "sarkık (acınası)" bir kopyaya dönüşmesi (fiziksel zayıflama) ile ödenen kaçınılmaz, genetik bir faturadır.',
    questionStem: 'Belyaev\'in Gümüş Tilki deneyinde (sadece uysal tilkiler seçildiğinde kulakların düşüp beneklerin çıkması), "Evcilleştirme (İtaat) ve Doğa" bağlamında neyin evrimsel bedelidir?',
    options: [
      'Rusya iklimindeki aşırı soğukların tilkilerin kulak kıkırdaklarını dondurarak kırdığının',
      'Vahşi doğanın (ve bir canlının) o yırtıcı, agresif (özgür) ruhunun koparılıp "uysal, itaatkâr (evcil)" bir yapıya zorlanmasının; sadece davranışsal bir değişimle kalmayıp, canlının o asil bedensel formunun da çökmesine (kulakların düşmesi/çenenin küçülmesi) yol açan zorunlu "genetik/fiziksel bir deformasyon faturası" olduğunun',
      'Tilkilerin laboratuvar ortamında kedi ve köpek mamaları yediği için sindirim sistemlerinin bozulduğunun',
      'Uysal hayvanların her zaman daha zeki olduğu için vücut enerjilerini sadece beyne yönlendirdiklerinin'
    ],
    correct: 1,
    explanation: 'Sadece "uysallık" (itaat) seçildiğinde tilkinin bedenen de değişip kulaklarının sarkması/küçülmesi; canlının özgür/vahşi ruhu alınıp itaatkâr (uysal) yapıldığında, bedenin de o asilliğini kaybedip zorunlu bir fiziksel deformasyon (çöküş) faturası ödediğini kanıtlar.'
  },
  {
    title: 'Wernicke Afazisi (Kelime Salatası ve İletişim İllüzyonu)',
    passage: 'Beyninin sol tarafındaki "Broca" alanı hasar gören bir hasta ne söylemek istediğini bilir ama kelimeleri ağzından çıkaramaz (fiziksel bir kilitlenme). Ancak beynin biraz daha gerisindeki "Wernicke" alanı hasar gördüğünde (Wernicke Afazisi), iletişim kavramı kelimenin tam anlamıyla bir şizofrenik (ve komik) kâbusa dönüşür! Wernicke hastası susmaz; o tamamen akıcı, harika tonlamalarla, jest ve mimiklerle saatlerce, durmaksızın konuşur! Ancak ağzından çıkan cümleler, dilbilgisi kuralına uyan ama hiçbir manası (ve bağı) olmayan uydurma heceler, alakasız kelime yığınları ("Köpek masanın üzerinde maviyi çizdi çünkü pencere hızlıdır" gibi) yani "Kelime Salatası" (Word Salad)dır. İşin en dondurucu felsefi şoku ise hastanın bunu "ASLA fark etmemesidir!" Hasta, çok anlamlı ve zekice bir şey anlattığından (karşısındakinin onu anladığından) %100 emindir! Wernicke Afazisi, bizim o çok övündüğümüz (sosyal) iletişimin altındaki o karanlık illüzyonu yırtar atar: Bizler çoğu zaman karşılıklı mantıklı şeyler konuştuğumuzu (birbirimizi anladığımızı) sanırız; oysa yaptığımız tek şey, karşımızdakinin zihnindeki dilsiz boşluğa, sadece akıcı ses frekansları (ve yüz mimikleri) fırlatarak "anlaşıldığımız sanrısıyla" kendi içimizde debelenmektir.',
    questionStem: 'Wernicke Afazisi\'ne yakalanan hastanın (anlamsız kelime salatası konuşurken) "çok mantıklı konuştuğunu (ve anlaşıldığını) sanması", iletişim eylemine dair nasıl bir felsefi eleştiri (illüzyon) sunar?',
    options: [
      'İnsanların sadece yabancı dil konuşurken kelimelerin sırasını yanlış dizdikleri şeklindeki dilbilgisi kuralını',
      'Beynin (ve insanın) kelimelerin asıl "anlamı (semantiği)" kaybolduğunda bile; sadece "akıcı sesler, jestler ve mimikler" kullanarak, karşı tarafla mantıklı bir iletişim kurduğu (anlaşıldığı) şeklindeki o sahte, kendi kendini kandıran ve dilsiz (şizofrenik) "iletişim illüzyonunu"',
      'Konuşma yetisinin tamamen akciğerlerin ve ses tellerinin fiziksel kapasitesine bağlı olduğu yönündeki tıbbi ezberi',
      'Erken yaşta çok kitap okuyan insanların beyinlerindeki kelime dağarcığının kasten daraldığı yalanını'
    ],
    correct: 1,
    explanation: 'Hastanın sıfır anlam (kelime salatası) üretmesine rağmen kendini çok mantıklı anlatıyor sanması; iletişimin bazen sadece akıcı seslerden (jestlerden) ibaret bir şov olduğu ve insanın "anlaşıldığını sandığı" o kendi içindeki dilsiz illüzyonu eleştirir.'
  },
  {
    title: 'Uyku Felci (Bedenin Zindanı)',
    passage: 'Gece uykunun en derin noktasında aniden gözlerinizi açarsınız. Zihniniz (bilinciniz) tamamen uyanıktır; odanın tavanını görür, saatin sesini duyarsınız. Ancak kolunuzu kaldırmak veya "İmdat!" diye bağırmak için bedeninize emir gönderdiğinizde, hiçbir şey (en ufak bir kas bile) kıpırdamaz! Vücudunuz kelimenin tam anlamıyla beton bir zindana dönüşmüş ve ruhunuzu (bilincinizi) felç ederek içine kilitlemiştir! Psikiyatri ve tıpta "Uyku Felci" (Karabasan) denen bu kâbus, beyin sapının o soğuk ve biyolojik bir savunma refleksidir. Bizler (Hızlı Göz Hareketi) REM uykusunda rüya görürken; beynimiz, rüyadaki hareketleri yatakta (fiziksel olarak) yapıp camdan atlamayalım veya kendimize zarar vermeyelim diye (motor nöronlara) bir sinyal yollayarak kaslarımızı geçici olarak TAMAMEN FELÇ EDER. Eğer o felç anında rüya bitmeden "bilinç" uyanırsa, zihin o karanlık (biyolojik) kilitlenmenin (felcin) içinde canlı canlı sıkışıp kalır. Uyku Felci, bizim o "bedenimin tek efendisi benim" kibrimize atılmış en çaresiz tokattır: Bedenimiz (ve evrim) bizim sadık hizmetkârımız değildir; gerektiğinde kendi bilincimizi (bizi korumak uğruna) en karanlık ve çığlık atılamayan sessiz bir kemik hapishanesine (zindana) kitleyip felç eden acımasız bir gardiyandır.',
    questionStem: 'Uyku Felci (Karabasan) durumunda (bilinç uyanıkken bedenin felç kalması), "Beden ve Bilinç" ilişkisi bağlamında neyin biyolojik (ve dondurucu) bir ispatıdır?',
    options: [
      'Geceleri yatak odalarındaki karbondioksit seviyesinin artarak beyinde geçici bayılmalara (senkop) yol açtığının',
      '"Bedenimi sadece benim (özgür) iradem yönetir" kibrini yıkarak; bedenin (evrimin), kişiyi rüyadan korumak uğruna bilincinden (iradesinden) tamamen bağımsız bir şekilde kasları felç ederek (şalteri kapatarak) aklı o dilsiz ve kemik zindana hapseden otonom bir gardiyan (ve efendi) olduğunun',
      'İnsanların karanlıktan korktukları için kasten gözlerini kapatarak yalandan uyku felci numarası yaptıklarının',
      'Uyku sırasında beynin tamamen kapandığı ve dış dünyadan hiçbir ses dalgasını algılayamadığı teorisinin'
    ],
    correct: 1,
    explanation: 'Bilinç açıkken bedenin (rüya için) kasları kitleyip aklı felç etmesi (Karabasan); "bedeni ben yönetirim" kibrini yıkarak, evrimin (bedenin) bizden habersiz bizi kitleyen otonom bir gardiyan/zindan olduğunu ispatlar.'
  },
  {
    title: 'Boantropi (Kralın Çöküşü)',
    passage: 'Tarihin gördüğü en görkemli, en güçlü (Babil Asma Bahçeleri\'ni inşa ettiren ve Kudüs\'ü yıkan) hükümdarı olan Babil Kralı II. Nabukadnezar, kudretinin ve kibrinin (tanrılaşma hırsının) en zirvesinde olduğu bir gün sarayından dışarı çıkar. Aniden aklındaki o incecik (ama hayat bağlayan) şalter atar! Kral elbiselerini yırtar, dört ayak üzerine çöker, tarlalara girip inekler gibi anırarak (böğürerek) ÇİMEN (OT) YEMEYE başlar! Eski Ahit\'te ve tarihi kayıtlarda yer alan bu akılalmaz düşüşe psikiyatride "Boantropi" (İnsanın kendini sığır veya öküz sanması hezeyanı) denir. Koca imparator, yedi yıl boyunca ormanlarda ve tarlalarda yağmurun altında bir öküz (hayvan) gibi çimen yiyerek yaşamıştır. Boantropi vakası; sadece tıbbi bir hastalık değil, insanoğlunun o "en üstün, en dokunulmaz ve tanrısal zekâ (medeniyet)" kibrine vurulmuş en absürt ve en aşağılayıcı felsefi prangadır. En yüce ve zeki sandığımız (medeniyet inşa eden) aklın sarayı; tek bir nörolojik kısa devreyle saniyeler içinde çöküp; kişiyi tarlada otlayan, anıran ve çamur çiğneyen çaresiz (ve acınası) bir hayvana (hayvani bir hiçliğe) döndürebilecek kadar pamuk ipliğine bağlıdır.',
    questionStem: 'Babil Kralı Nabukadnezar\'ın (Boantropi hastalığıyla) kendini inek sanıp tarlada ot yemesi, "İnsan Zekâsı ve Kibri (Medeniyet)" hakkında neyin en absürt (ve trajik) kanıtıdır?',
    options: [
      'Antik dönemde kralların halkla bağ kurmak için doğayla iç içe olmayı (tarımı) desteklemek adına sembolik ritüeller yaptığının',
      'İnsanoğlunun o en yüce, tanrısal (ve medeniyet inşa eden) zekâsının (kibrinin) bile; aslında küçücük nörolojik bir kısa devreyle saniyeler içinde çöküp; koca bir kralı tarlada ot yiyen, çamur çiğneyen acınası bir hayvana (hayvani bir hezeyana) çevirebilecek kadar kırılgan ve pamuk ipliğine bağlı olduğunun',
      'Sebze ve ot ağırlıklı beslenmenin insan aklını zehirleyerek şizofreniyi tetiklediği yönündeki diyetetik dogmanın',
      'Eski Babil tanrılarının aslında öküz şeklinde olduğu için kralların da o forma girmek istediğinin'
    ],
    correct: 1,
    explanation: 'Koca kralın (Boantropi hezeyanıyla) inek gibi ot yemesi; insanın o yüce, tanrısal medeniyet (zekâ) kibrinin, beyindeki küçücük bir kısa devreyle saniyeler içinde çöküp kişiyi otlayan (çaresiz) bir hayvana döndürecek kadar kırılgan (pamuk ipliği) olduğunu kanıtlar.'
  },
  {
    title: 'Kaledonya Kargaları (Zekânın Tüyü)',
    passage: 'İnsanoğlu binlerce yıl boyunca sadece kendisinin ve evrimsel kuzeni olan şempanzelerin (primatların) alet yapabildiğini, zekânın sadece o omuzların üzerindeki koca (insansı) beyin korteksine ait kutsal bir tekel olduğunu savundu. Ancak biyologlar Güney Pasifik\'teki Yeni Kaledonya Kargaları\'nı (Corvus moneduloides) incelediğinde bu kibir yerle bir oldu. Bir karganın önüne dar ve uzun bir cam tüp, tüpün dibine bir yiyecek ve içine bir miktar su kondu. Karganın gagası o derin tüpe uzanamıyordu. Karga ne yaptı dersiniz? Etraftaki ağır taşları topladı, gagasında biriktirdi ve tek tek o cam tüpün (suyun) içine atmaya başladı! Ezop\'un o meşhur masalındaki gibi, taşlar tüpün dibine çöktükçe suyun (Arşimet) seviyesi yükseldi ve yiyecek en tepeye çıkınca karga onu yedi! Daha da dehşetlisi, bu kargalar düz telleri gagalarıyla (ve ayaklarıyla) bükerek (kanca şekline getirip) daracık ağaç kovuklarından larvaları çekip çıkarıyorlardı. Kaledonya Kargaları; zekânın (alet yapmanın, fizik kurallarını hesaplamanın) insanlara veya maymunlara has o kibirli ve merkezi bir "Kafatası (Primat)" tekeli olmadığını; bilincin ve dehanın (fiziğin), gökyüzünde kanat çırpan ceviz büyüklüğündeki tüylü bir beynin içinde de aynı soğuklukta, aynı dâhiyanelikte parladığını yüzümüze çarpan o siyah kanatlı felsefedir.',
    questionStem: 'Yeni Kaledonya Kargalarının suyun seviyesini taşlarla yükselterek (Arşimet kuralını) kullanması ve teli kanca yapması, biyoloji ve zekâ algımızdaki hangi "merkezi (kibirli)" ezberi darmadağın etmektedir?',
    options: [
      'Kuşların sadece içgüdüsel (ve genetik) olarak yuva yapabilen, öğrenme yetisinden tamamen yoksun (hafızasız) canlılar olduğu gerçeğini',
      'Zekânın, problem çözmenin ve "alet (fizik) kullanımının" sadece insana veya şempanzelere (primatların büyük beynine) ait kutsal bir tekel (kibir) olduğu ezberini yıkarak; aklın, ceviz büyüklüğündeki tüylü bir (kuş) beyninde de aynı kusursuz (ve soğuk) dâhiyanelikte parlayabileceğini',
      'Suda yüzen nesnelerin zamanla ağırlıklarını kaybederek kargalar tarafından daha kolay yutulduğu fiziksel kuralını',
      'Kargaların aslında insanları kasten taklit etmek için sirklerde eğitilmiş özel hayvanlar olduğu yönündeki iddiayı'
    ],
    correct: 1,
