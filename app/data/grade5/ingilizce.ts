  ...
  term1: {
    test1: [
      ...
      },
      {
        ...
        correct: 0,
        explanation: "Milliyet Turkish'tir.",
      },
      {
        id: "e5-1-03",
        subject: "ingilizce",
        ...
        correct: 1,
        explanation: "Science bir derstir.",
      },
      {
        id: "e5-1-04",
        subject: "ingilizce",
        ...
        correct: 1,
        explanation: "İki yer arası 'between'dir.",
      },
      {
        id: "e5-1-05",
        subject: "ingilizce",
        ...
        correct: 2,
        explanation: "But zıtlık verir, can't kullanılır.",
      },
      {
        id: "e5-1-11",
        subject: "ingilizce",
        ...
        correct: 1,
        explanation: "Üstünde anlamı verir.",
      },
      {
        id: "e5-1-13",
        subject: "ingilizce",
        ...
        correct: 1,
        explanation: "Matematik problem çözmektir.",
      },
      {
        id: "e5-1-15",
        subject: "ingilizce",
      ...
      },
      {
        ...
        correct: 1,
        explanation: "Ders çalışma yeri okuldur.",
      },
      {
        id: "e5-zn-13",
        subject: "ingilizce",
        ...
        correct: 2,
        explanation: "Yer sorarken Where kullanılır.",
      },
      {
        id: "e5-zn-15",
        subject: "ingilizce",
        ...
        correct: 2,
        explanation: "Milliyet Japonca (Japanese).",
      },
      {
        id: "e5-zn-17",
        subject: "ingilizce",
        ...
        correct: 0,
        explanation: "Satranç içeride oynanır.",
      },
      {
        id: "e5-zn-19",
        subject: "ingilizce",
      ...
      },
      {
        ...
        term: 1,
        prompt:
          "Jack: 'I like history and solving problems.' Which subjects does he like?",
        options: [
          "Art and Music",
        ...
        correct: 1,
        explanation: "History Social Studies, problems Maths.",
      },
      {
        id: "e5-hard-nv-04",
        subject: "ingilizce",
        ...
        options: ["under", "between", "on", "at"],
        correct: 1,
        explanation: "Arasında anlamında.",
      },
      {
        id: "e5-adv-01",
        subject: "ingilizce",
        term: 1,
        prompt:
          "Jane: 'I don't like horror movies. They are frightening.' Which movie type does Jane prefer?",
        options: ["Horror", "Cartoons", "Thriller", "Action"],
        correct: 1,
        explanation: "Korkmuyorsa çizgi film tercih eder.",
      },
      {
        id: "e5-adv-04",
        subject: "ingilizce",
      ...
      },
      {
        ...
        term: 1,
        prompt:
          "A: 'Where is the hospital?' B: 'Go straight and turn left. It is ____ the park.'",
        options: ["next to", "under", "in", "at"],
        correct: 0,
        explanation:
          "Yer tariflerinde 'yanında' anlamında 'next to' kalıbı kullanılır.",
      },
      {
        id: "e5-1-22",
        subject: "ingilizce",
