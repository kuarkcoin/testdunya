...
export default function Footer() {
  ...
  return (
    <footer className="bg-white/90 dark:bg-zinc-900/60 border-t border-slate-200 dark:border-zinc-700 mt-auto backdrop-blur-md transition-all duration-300">
      <div className="max-w-6xl mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="mt-4 text-slate-500 dark:text-zinc-300 text-sm leading-relaxed max-w-sm">
              YKS, KPSS, TUS, DUS ve daha fazlası... Türkiye'nin en kapsamlı ücretsiz online deneme sınavı ve soru çözüm platformu.
            </p>
          </div>

          {/* 2. Kolon: Hızlı Linkler */}
          <div>
            <h3 className="font-semibold text-slate-900 dark:text-white mb-4">Kurumsal</h3>
            <ul className="space-y-3 text-sm text-slate-600 dark:text-zinc-300">
              ...
              <li>
                <Link href="/iletisim" className="text-blue-600 hover:text-blue-700 dark:text-blue-400 dark:hover:text-blue-300 transition-colors">
                  İletişim
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-slate-600 dark:text-zinc-300">
              <li>
                <Link href="/cookie" className="text-blue-600 hover:text-blue-700 dark:text-blue-400 dark:hover:text-blue-300 transition-colors">
                  Çerez Politikası
                </Link>
              </li>
              <li>
                <Link href="/gizlilik" className="text-blue-600 hover:text-blue-700 dark:text-blue-400 dark:hover:text-blue-300 transition-colors">
                  Gizlilik Sözleşmesi
                </Link>
              </li>
            </ul>
        ...
        {/* Alt Çizgi: Copyright */}
        <div className="border-t border-slate-200 dark:border-zinc-700 mt-12 pt-8 flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-xs text-slate-500 dark:text-zinc-300 text-center md:text-left">
            © {currentYear} TestDünya. Tüm hakları saklıdır.
          </p>
          <div className="flex gap-4">
            {/* Sosyal Medya İkonları (Basit SVG) */}
